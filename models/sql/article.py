...
from mongotest.lib.powlib import relation
from mongotest.database.sqldblib import Base, engine
from mongotest.lib.powlib import PowBaseMeta

#@relation.has_many("<plural_other_models>")
@relation.setup_sql_schema()
class Article(Base, metaclass=PowBaseMeta):
