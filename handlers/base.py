...
import json
from mongotest.conf import config as cfg
import os
#from mongotest.models.sql.user import User
...
class BaseHandler(tornado.web.RequestHandler):
    ...
    def success(self, data=None, message="", pure=False, succ=None, prev=None,
        ...
        self.application.log_request(self, message="basehandler.success:" + message)
