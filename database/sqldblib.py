...
#
from mongotest.conf.config import database, myapp
...
#from mongotest.models.sql.basemodel import SqlBaseModel
from mongotest.models.sql.sqlmodel import SqlModel
