...
server_settings = {
    ...
    "cookie_secret"     :   "ae36a710-67e0-4505-9392-2ac99a097f3b",
    "ssl"               :   False,
    "ssl_options"       :   {
...
myapp = {
    "app_name"          :   "mongotest",
    "app_description"   :   """ best app ever for testing mongodb""",
    "ap_version"        :   "0.0.1"
    ...
    "default_format"    :   "json",
    "encoder"           :   {
           "json"   :   mongotest.lib.encoders.json_to_json(),
            "csv"   :   mongotest.lib.encoders.json_to_csv(),
            "xml"   :   mongotest.lib.encoders.json_to_xml()
    },
    "byte_decoding"     :   "utf-8",
